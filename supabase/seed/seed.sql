...
values
  (
    ...
    '{"sub":"00000000-0000-0000-0000-000000000001","email":"ana@example.com","email_verified":true}',
    now(), now(), now()
  ),
  (
    gen_random_uuid(), '00000000-0000-0000-0000-000000000002',
    '00000000-0000-0000-0000-000000000002', 'email',
    '{"sub":"00000000-0000-0000-0000-000000000002","email":"luis@example.com","email_verified":true}',
    now(), now(), now()
  );
...
values
  ('00000000-0000-0000-0000-000000000001', 'ana@example.com', 'Ana Example'),
  ('00000000-0000-0000-0000-000000000002', 'luis@example.com', 'Luis Example');
...
values
  ('22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111111', 'Kitchen', 1),
  ('22222222-2222-2222-2222-222222222202', '11111111-1111-1111-1111-111111111111', 'Main bathroom', 2),
  ('22222222-2222-2222-2222-222222222203', '11111111-1111-1111-1111-111111111111', 'Living room', 3);

insert into public.trades (id, project_id, name, sort_order)
values
  ('33333333-3333-3333-3333-333333333301', '11111111-1111-1111-1111-111111111111', 'Electrical', 1),
  ('33333333-3333-3333-3333-333333333302', '11111111-1111-1111-1111-111111111111', 'Plumbing', 2),
  ('33333333-3333-3333-3333-333333333303', '11111111-1111-1111-1111-111111111111', 'Painting', 3);
...
values
  (
    '11111111-1111-1111-1111-111111111111', 'E-01', 'Replace electrical panel',
    '33333333-3333-3333-3333-333333333301', null, 1, 'unit', 950, 950
  ),
  (
    '11111111-1111-1111-1111-111111111111', 'P-01', 'Kitchen plumbing rough-in',
