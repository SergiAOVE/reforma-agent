  ...
  public: {
    Tables: {
      ...
      document_insights: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_insights_created_by_fkey";
            columns: ["created_by"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "document_insights_created_by_job_id_fkey";
            columns: ["created_by_job_id"];
            isOneToOne: false;
            referencedRelation: "agent_jobs";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "document_insights_reviewed_by_fkey";
            columns: ["reviewed_by"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
